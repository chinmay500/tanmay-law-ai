...
const MarkdownComponents: Partial<Components> = {
    ...
    pre: ({ ...props }) => (
        <pre className="bg-slate-100 dark:bg-slate-800 rounded p-4 mb-4 overflow-x-auto" {...props} />
    ),
};
                                ...
                                {messages.length === 0 ? (
                                    <div className="flex flex-col items-center justify-center h-[50vh] text-center px-4">
                                        ...
                                        <p className="mt-2 text-slate-500 dark:text-slate-400 max-w-md">
                                            Your AI-powered legal research companion. Ask any question about Indian law
                                            and get accurate, up-to-date information.
                                        </p>
                                    </div>
                                ) : (
                                    messages.map((message) => (
                                        ...
                                        >
                                            <div
                                                className={`flex h-8 w-8 shrink-0 rounded-full items-center justify-center ${message.role === 'user'
                                            ...
                                            <div className={`flex flex-col gap-1 ${message.role === 'user' ? 'items-end' : 'items-start'
                                                ...
                                                <div
                                                    className={`max-w-[600px] rounded-2xl px-4 py-2 ${message.role === 'user'
                                                        ? 'bg-indigo-600 text-white'
